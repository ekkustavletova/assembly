...
// assembly.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CassemblyApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CassemblyApp::OnAppAbout)
...
// Создание CassemblyApp

CassemblyApp::CassemblyApp() noexcept
{
	...
	SetAppID(_T("assembly.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CassemblyApp

CassemblyApp theApp;


// Инициализация CassemblyApp

BOOL CassemblyApp::InitInstance()
{
...
// Обработчики сообщений CassemblyApp
